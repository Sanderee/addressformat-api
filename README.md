...
### `GET /health`
Health check. Used by Render and RapidAPI monitoring.
...
See [`RAPIDAPI.md`](./RAPIDAPI.md) for the full deployment + listing guide.
...
Address format conventions informed by the [OpenCage address-formatting project](https://github.com/OpenCageData/address-formatting) (CC-BY), Universal Postal Union guidelines, and national postal operator documentation (PostNL, Deutsche Post, Royal Mail, USPS, Canada Post, Japan Post, Australia Post, et al.).
